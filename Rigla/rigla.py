...
def main ():
  ...
  for point in geo['features']:
        scv += f"\n{point['properties']['address']};{point['geometry']['coordinates'][1]};{point['geometry']['coordinates'][0]}"

  print(scv)
    
  fp = open('rigla.csv', 'w', encoding='utf8')
  fp.write(scv)
  fp.close
